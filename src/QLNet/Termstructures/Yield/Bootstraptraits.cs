...
namespace QLNet
{
    ...
    public static class ITraitsYieldTermStructure
    {
            ...
            where Interpolator : class, IInterpolationFactory, new()
        {
            ...
            /*else if (self.GetType().Equals(typeof(ZeroYield)))
                return new InterpolatedZeroCurve<Interpolator>(dates, discounts, dayCounter, jumps, jumpDates, interpolator);*/
            else if (self.GetType().Equals(typeof(ForwardRate)))
	...
	public class Discount : ITraits<YieldTermStructure>
	{
        ...
        public double minValueAfter<C>(int i, C c, bool validData, int f) where C : Curve<YieldTermStructure>
		{
			if ( validData )
			{
        ...
        public double maxValueAfter<C>(int i, C c, bool validData, int f) where C : Curve<YieldTermStructure>
		{
