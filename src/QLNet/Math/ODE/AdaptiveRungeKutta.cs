...
namespace QLNet
{
    public class AdaptiveRungeKutta
    {
        ...
        */
        ...
        {
            int n=y.Count;
            List<double> ak2 = new List<double>(n), ak3 = new List<double>(n), ak4 = new List<double>(n), 
                         ak5 = new List<double>(n), ak6 = new List<double>(n), ytemp = new List<double>(n);
        ...
        protected const double ADAPTIVERK_MAXSTP = 10000.0, ADAPTIVERK_TINY = 1.0E-30, ADAPTIVERK_SAFETY = 0.9,
                     ADAPTIVERK_PGROW = -0.2, ADAPTIVERK_PSHRINK = -0.25, ADAPTIVERK_ERRCON = 1.89E-4;
