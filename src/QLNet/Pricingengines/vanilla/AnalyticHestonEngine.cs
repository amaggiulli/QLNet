...
{
   /// <summary>
   /// Analytic Heston-model engine based on the Fourier transform.
   /// </summary>
   /// <remarks>
   /// Two algebraically equivalent formulations of the complex logarithm in the Heston model exist. Gatheral's formulation avoids discontinuities and works with adaptive integration routines, so it is preferred over the original Heston formulation.
   /// </remarks>
