   ...
   public class IsdaCdsEngine : CreditDefaultSwap.Engine
   {
      ...
      */
      ...
      public override void calculate()
      {
         ...
         var castY5 = discountCurve_.link as InterpolatedDiscountCurve<LogLinear>;
         ...
         var castC4 = probability_.link as PiecewiseDefaultCurve<SurvivalProbability, LogLinear>;
         var castC5 = probability_.link as PiecewiseDefaultCurve<HazardRate, BackwardFlat>;
         ...
         // Todo check
         List<Date> nodes = yDates.Union(cDates).OrderBy(x => x).ToList();
         ...
         results_.additionalResults.Clear();
         ...
         if (results_.couponLegNPV.IsNotEqual(0.0))
         {
            results_.fairSpread =
               ...
               (results_.couponLegNPV - accruedAmount + results_.accrualRebateNPV);
         }
         else
         {
         ...
         results_.additionalResults.Add("accruedAmount", accruedAmount);
      }
