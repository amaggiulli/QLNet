      ...
      */
      ...
      public static string nextCode(String ecbCode)
      {
         ...
         if (monthString == "JAN")
            ...
            result += "MAR" + code.Substring(3, 2);
         else if (monthString == "MAR")
            result += "APR" + code.Substring(3, 2);
         else if (monthString == "APR")
            result += "MAY" + code.Substring(3, 2);
         else if (monthString == "MAY")
            result += "JUN" + code.Substring(3, 2);
         else if (monthString == "JUN")
            result += "JUL" + code.Substring(3, 2);
         else if (monthString == "JUL")
            result += "AUG" + code.Substring(3, 2);
         else if (monthString == "AUG")
            result += "SEP" + code.Substring(3, 2);
         else if (monthString == "SEP")
            result += "OCT" + code.Substring(3, 2);
         else if (monthString == "OCT")
            result += "NOV" + code.Substring(3, 2);
         else if (monthString == "NOV")
