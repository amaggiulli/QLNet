...
namespace QLNet
{
    public class FdmLinearOpIterator
    {
        ...
        public List<int> coordinates() { return coordinates_; }

        public void swap(FdmLinearOpIterator iter)
        {
            Utils.swap<int>(ref iter.index_, ref index_);
            Utils.swap<List<int>>(ref iter.dim_, ref dim_);
            Utils.swap<List<int>>(ref iter.coordinates_, ref coordinates_);
        }
