      ...
      void addEffectiveInterestRateAmortizing()
      {
         ...
         for (int i = 1; i < schedule.Count; ++i)
         {
            ...
            if (i > 1)
            {
               ...
               r2 = new FixedRateCoupon(currentNominal, actualDate, rate2, prevDate, actualDate, prevDate, actualDate, _originalPayment);
            }
            ...
            else
            {
               ...
               r2 = new FixedRateCoupon(currentNominal, actualDate, rate2, testDate, actualDate, prevDate, actualDate, _originalPayment);
            }
