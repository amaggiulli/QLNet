...
namespace TestSuite
{
   ...
   internal class FirstDeJong : CostFunction
   {
      public override Vector values(Vector x)
      {
   ...
   internal class SecondDeJong : CostFunction
   {
      public override Vector values(Vector x)
      {
         Vector retVal = new Vector(x.size(), value(x));
   ...
   internal class ModThirdDeJong : CostFunction
   {
      public override Vector values(Vector x)
      {
         Vector retVal = new Vector(x.size(), value(x));
   ...
   internal class ModFourthDeJong : CostFunction
   {
      ...
      private MersenneTwisterUniformRng uniformRng_;
   }

   internal class Griewangk : CostFunction
   {
      public override Vector values(Vector x)
      {
         Vector retVal = new Vector(x.size(), value(x));
