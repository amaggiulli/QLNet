   ...
   public class T_CreditDefaultSwap
   {
      ...
      public void testCachedValue()
      {
         ...
         using (SavedSettings backup = new SavedSettings())
         {
            ...
            CreditDefaultSwap cds = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, notional, fixedRate,
      ...
      public void testCachedMarketValue()
      {
         ...
         using (SavedSettings backup = new SavedSettings())
         {
            ...
            CreditDefaultSwap cds = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, cdsNotional, fixedRate,
      ...
      public void testFairSpread()
      {
         ...
         using (SavedSettings backup = new SavedSettings())
         {
            ...
            CreditDefaultSwap fairCds = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, notional, fairRate,
                                    schedule, convention, dayCount, true, true);
      ...
      public void testFairUpfront()
      {
         ...
         using (SavedSettings backup = new SavedSettings())
         {
            ...
            CreditDefaultSwap cds = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, notional, upfront, fixedRate,
                                 schedule, convention, dayCount, true, true);
            cds.setPricingEngine(engine);

            double fairUpfront = cds.fairUpfront();

            CreditDefaultSwap fairCds = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, notional,
            ...
            upfront = 0.0;
            CreditDefaultSwap cds2 = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, notional, upfront, fixedRate,
                                 schedule, convention, dayCount, true, true);
            cds2.setPricingEngine(engine);

            fairUpfront = cds2.fairUpfront();

            CreditDefaultSwap fairCds2 = new CreditDefaultSwap(CreditDefaultSwap.Protection.Side.Seller, notional,
                                       fairUpfront, fixedRate, schedule, convention, dayCount, true, true);
