   ...
   public class T_SwaptionVolatilityCube
   {
      public class CommonVars 
      {
        ...
        //public SavedSettings backup = new SavedSettings();
         ...
         public CommonVars() 
         {
            Singleton<Settings>.link.setEvaluationDate(new Date(16, Month.September, 2015));
      ...
      public void testObservability() 
      {
         ...
         Singleton<Settings>.link.setEvaluationDate(vars.conventions.calendar.advance(referenceDate, new Period(1, TimeUnit.Days),
